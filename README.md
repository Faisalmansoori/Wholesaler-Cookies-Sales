...
<h2><a class="anchor" id="tools--technologies">Tools & Technology</a>
- Excel (Functions, Pivot Charts, Interactive Dashboards)
- SQL   (COMMON TABLE EXPRESSION, JOINS, FILTERING)
- Github

---

<h2><a class="anchor" id="data-cleaning--preparation">Data Cleaning & Preparation</a>
- Remove Blank Rows
- Remove duplicate Rows

---

<h2><a class="anchor" id="exploratory-data-analysis-eda">Exploratory Data Analysis (EDA)</a>
